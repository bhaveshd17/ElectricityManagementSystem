...
public class CustomerDetails1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CustomerDetails1 frame = new CustomerDetails1();
	...
	public CustomerDetails1() {
        ...
        searchBtn.setBounds(271, 46, 91, 26);
        searchBtn.setForeground(new Color(255, 255, 255));
        searchBtn.setBackground(new Color(0, 0, 0,100));
        ...
        btn3_panel.setBounds(871, 46, 109, 26);
