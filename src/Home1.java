...
public class Home1 extends JFrame {
	...
	public Home1() {
        ...
        newCustomerMenu.setEnabled(false);
        ...
        //Customer Detail
        JMenuItem customerDetailsMenu = new JMenuItem("Customer Detail");
        customerDetailsMenu.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		String msg = e.getActionCommand();
        ...
        customerDetailsMenu.setForeground(new Color(255, 255, 255));
        customerDetailsMenu.setBackground(new Color(0, 0, 0,200));
        Home.add(customerDetailsMenu);
      ...
      //Third column
        ...
        JLabel lblNewLabel_1 = new JLabel(" Power Surge");
        lblNewLabel_1.setForeground(new Color(255, 255, 255));
        lblNewLabel_1.setFont(new Font("Segoe UI", Font.BOLD, 70));
        lblNewLabel_1.setBounds(278, 122, 502, 177);
